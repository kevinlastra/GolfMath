...
Le chemin ainsi généré, on va passer case par case dans notre grille et on va tester si la distance entre la case est un point du chemin est inférieur à un certain nombre.
